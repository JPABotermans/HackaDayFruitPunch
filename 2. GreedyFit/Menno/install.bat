...
copy hackathon_31032019_18.crt "%ProgramFiles% (x86)\openvpn\config\"
copy hackathon_31032019_18.key "%ProgramFiles% (x86)\openvpn\config\"
copy psscopenvpn.crt "%ProgramFiles% (x86)\openvpn\config\"
copy hackathon_31032019_18.psscopenvpn.ovpn "%ProgramFiles% (x86)\openvpn\config\"
echo "Files copied to %ProgramFiles% (x86)\openvpn\config\"
)
 
if exist "%ProgramFiles%\openvpn\config"	(
copy hackathon_31032019_18.crt "%ProgramFiles%\openvpn\config\"
copy hackathon_31032019_18.key "%ProgramFiles%\openvpn\config\"
copy psscopenvpn.crt "%ProgramFiles%\openvpn\config\"
copy hackathon_31032019_18.psscopenvpn.ovpn "%ProgramFiles%\openvpn\config\"
...
del hackathon_31032019_18.crt
del hackathon_31032019_18.key
del psscopenvpn.crt
del hackathon_31032019_18.psscopenvpn.ovpn
